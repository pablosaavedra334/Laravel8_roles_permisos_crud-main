...
<body>
    ...
    <div class="bordet">
        ...
        <p>Carrera Ingeniería Electronica</p> <h1 class="t1"> <strong>SISTEMA BIBLIOTECA</strong> </h1>
    </div>
  ...
  <div class="container-fluid">
    ...
    <div class="container" >
      ...
      <p>   Formar procionales competitivos capacitados para resolver problemas especiales de diversa índole, desarrolando en el estudiante destrezas en el manejo de los insrumentos de dibujo para la construcción de figuras y cuerpos gemétricos que identifican la proyección ortogonal, realizado manualemente y con la utilización de software correspondiente.
       </p>

       <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../../Img/005.jpg" class="d-block w-100" alt="...">
          </div>
